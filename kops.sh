...
aws s3api create-bucket --bucket swapnil-kops-testbkt1433.k8s.local --region ap-south-1 --create-bucket-configuration LocationConstraint=ap-south-1
aws s3api put-bucket-versioning --bucket swapnil-kops-testbkt1433.k8s.local --region ap-south-1 --versioning-configuration Status=Enabled
export KOPS_STATE_STORE=s3://swapnil-kops-testbkt1433.k8s.local
